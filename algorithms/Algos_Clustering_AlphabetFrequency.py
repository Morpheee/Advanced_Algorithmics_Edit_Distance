...
"""Variables"""
#Updating test size
testsize = 0.025 #only using 2.5% of the dataset for the experiments, but can change to 1% ro run quickly
##Updating charts based on number of clusters 3 or 4
#change {labels3 and labels3_1} or {labels4 and labels4_1} depending on which clustering group to analyze"""
label = 'labels3' 
labelX = 'labels3_1' #
...
X_train, X_test, y_train, y_test = train_test_split(
    ...
    test_size=testsize, #only using 2.5% of the dataset
    random_state=4269,
...
##plotting 3 or 4 group clusters
sns.scatterplot(data = pair_proteins, x = labelX, y = 'ed')
